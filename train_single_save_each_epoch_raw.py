...
'''
python train_single_save_each_epoch.py --loss_type CE+Dice_config_0 --resume False --augm 4 --drop 0.4 --patch_size 3 --window_size 8
...
train_path = main_data_path +'train_data/'+ data_type+'/train'
#val_path = main_path + 'train_data/'+data_type+'/val'
loss_type  = args.loss_type
record_type = data_type + '_'+loss_type      #save train loss logger ==> jpg

save_patch = main_path +'/work_dirs/weight/'+data_type+'_save_each_eopch_'+'ws_'+str(args.window_size)\
            +'_'+loss_type+'/'
...
logger.info('augm type {}'.format(augm))
