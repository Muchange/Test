...
'''
python test_single_each_epoch.py --patient_type tumor --loss_type CE+Dice_config_0 --augm 4 --patch_size 3 --drop 0.5 --window_size 8
'''
...
logger_path = main_path + 'test_result/save_each_epoch/logger/'+data_type+'_'+loss_type+'/'
