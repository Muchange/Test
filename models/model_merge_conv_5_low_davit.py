...
from .model_parts_merge_conv_5_low_davit import *
...
class MCM_Hit_mor(nn.Module):
    def __init__(self, n_channels=1, n_classes=9, window_size=(8,8)):
        ...
        self.low = low_davit(in_channels = num_channels[4], num_heads = num_heads,
                             embed_dim = embed_dim,window_size = window_size,drop_path = drop)
        ...
        self.up5 = de_up(in_channels = num_channels[4],up_channels=up_num_channels[4],out_channels = num_channels[4])
    ...
    def forward(self, x):
        ...
        up5 = self.up5(low, merge5)
        up4 = self.up4(up5, merge4)
