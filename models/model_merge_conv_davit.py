...
from .model_parts_merge_conv_davit import *
...
class MCM_Hit_mor(nn.Module):
    def __init__(self, n_channels=1, n_classes=9, window_size=(8,8)):
        ...
        num_channels = [32,64,128,256,768]
        ...
        self.merge4 = merge_c2f_d(in_channels = num_channels[2], out_channels = num_channels[3],type= 'down')

        self.low = low_davit(in_channels = num_channels[3], num_heads = num_heads,
                             embed_dim = embed_dim,window_size = window_size,drop_path = drop_path)
